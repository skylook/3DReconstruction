...
CAMERA_SENSOR_WIDTH_DIRECTORY = "/Users/leemeng/code/reconstruction/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"),  "-i", input_dir, "-o", matches_dir, "-d", camera_file_params, "-f", "4838.4"] )
pIntrisics.wait()
